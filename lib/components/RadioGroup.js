	...
	render: function render() {
		...
		var radios = this.props.options.map(function (radio, i) {
			...
			return React.createElement(
				...
				React.createElement('input', { value: radio.value, checked: self.state.currentValue == radio.value ? true : false, type: 'radio', onChange: self.handleChange, onBlur: self.handleBlur, name: self.props.name, className: 'Radio__input', disabled: this.props.disabled }),
				React.createElement(
					'span',
